    ...
    return MultiProvider(
      ...
      child: Consumer<AuthProvider>(
        builder: (context, auth, _) {
          final String? userId = auth.firebaseUser?.uid;
          
          final List<SingleChildWidget> healthProviders = userId == null
              ? []
              : [
                  ChangeNotifierProvider(create: (_) => HomeProvider(userId)),
                  ChangeNotifierProvider(create: (_) => WaterProvider(userId)),
                  ChangeNotifierProvider(create: (_) => StepsProvider(userId)),
                  ChangeNotifierProvider(create: (_) => NutritionProvider(userId)),
                  ChangeNotifierProvider(create: (_) => SleepProvider(userId)),
                  ChangeNotifierProvider(create: (_) => WeightProvider(userId)),
                  ChangeNotifierProvider(create: (_) => VitalsProvider(userId)),
                  ChangeNotifierProvider(create: (_) => MedicationProvider(userId)),
                  ChangeNotifierProvider(create: (_) => WorkoutProvider(userId)),
                ];
